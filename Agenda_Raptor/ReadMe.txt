========================================================================
    APLICACIÓN: Información general del proyecto Agenda_Raptor
========================================================================

AppWizard ha creado esta aplicación Agenda_Raptor.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación Agenda_Raptor.

Agenda_Raptor.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Agenda_Raptor.pch y un archivo de 
